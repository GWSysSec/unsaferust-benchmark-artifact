//! Balanced unsafe-oriented test for `rmp` (RQ1 cycles + RQ2 heap + RQ3 insts).
//!
//! rmp's own unsafe is minimal; the safe encode/decode path dominates.
...
const SAFE_ITERS: u64 = 11739268; // safe LCG iters: instruction/cycle dilution (no heap)
const SAFE_ALLOCS: u64 = 1306; // safe heap allocations: memory dilution (RQ2)
