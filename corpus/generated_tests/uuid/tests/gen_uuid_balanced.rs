//! Balanced unsafe-oriented test for `uuid` (RQ1 cycles + RQ2 heap + RQ3 insts).
//!
//! uuid's own unsafe (byte/array reinterprets) is a tiny cycle fraction, rounding
//! to 0 on RQ1.
...
const SAFE_ITERS: u64 = 11817078; // safe LCG iters: instruction/cycle dilution (no heap)
const SAFE_ALLOCS: u64 = 1312; // safe heap allocations: memory dilution (RQ2)
