...
fn sleb128_read_multibyte() {
    // -123456 sleb128 encoding: 0xc0, 0xbb, 0x78
    ...
    // 624485 sleb128 encoding: 0xe5, 0x8e, 0x26
    ...
    // 64 (boundary, requires 2 bytes): 0xc0, 0x00
...
fn sleb128_read_sequential_and_errors() {
    // Sequential reads from concatenated stream: 0, 1, -1, 64
