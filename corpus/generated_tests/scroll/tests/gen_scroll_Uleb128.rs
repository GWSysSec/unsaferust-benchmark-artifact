...
fn test_uleb128_read_multi_byte_624485() {
    // canonical LEB128 example: 624485 = 0xE5 0x8E 0x26
...
fn test_uleb128_read_sequential() {
    // encode 0x01, then 128 (0x80 0x01), then 0x7f
...
fn test_uleb128_read_truncated_returns_error() {
    // 0x80 alone signals continuation but there's no next byte
    let bytes = [0x80];
    let mut offset = 0usize;
