...
fn test_code_block_kind_is_indented_true() {
    ...
    // Verify the indented kind variant directly
...
fn test_code_block_kind_is_fenced_true() {
    ...
    // Verify the fenced kind variant directly
...
fn test_code_block_kind_fenced_without_language() {
    ...
    // Construct directly with empty info
...
fn test_code_block_kind_into_static_indented() {
    ...
    // Verify it's truly 'static by using it in a context that requires 'static
...
fn test_code_block_kind_into_static_fenced_complex_info() {
    // Info strings can contain spaces and other characters (only first word is language)
    let md = "```rust,no_run\nlet x = 1;\n```\n";
    let parser = Parser::new(md);
...
fn test_code_block_kind_multiple_blocks_mixed() {
    ...
    // Verify the static kinds retain their properties
...
fn test_code_block_kind_tilde_fenced() {
    ...
    // Also test into_static with tilde fence
...
fn test_code_block_kind_into_static_preserves_long_info_string() {
    // Test with a longer info string that would require owned allocation
    ...
    // Double check the indented variant for completeness
...
fn test_code_block_kind_equality_and_behavior() {
    // Test that is_indented and is_fenced are mutually exclusive for all variants
    ...
    for kind in &variants {
        // Mutual exclusivity: exactly one of is_indented/is_fenced is true
