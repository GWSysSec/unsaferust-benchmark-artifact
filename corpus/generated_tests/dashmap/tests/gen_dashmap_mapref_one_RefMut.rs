...
fn test_refmut_downgrade() {
    ...
    // While holding the read ref, we can still read another entry
    ...
    // After drop we can mutate again
...
fn test_refmut_try_map_success_and_failure() {
    ...
    // Successful try_map on Some entry
    ...
    // Failed try_map on None entry — returns Err with original RefMut
