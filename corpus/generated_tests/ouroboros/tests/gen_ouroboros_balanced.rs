//! Balanced unsafe-oriented test for `ouroboros` (RQ1 cycles + RQ2 heap + RQ3 insts).
//!
//! The macro-generated unsafe ouroboros emits (change_lifetime / aliasing)
//! executes only a few instructions per call.
...
const SAFE_ITERS: u64 = 11840395; // safe LCG iters: instruction/cycle dilution (no heap)
const SAFE_ALLOCS: u64 = 1316; // safe heap allocations: memory dilution (RQ2)
