//! Balanced unsafe-oriented test for `flate2` (RQ1 cycles + RQ2 heap + RQ3 insts).
//!
//! flate2's own-crate unsafe (slice/FFI-buffer handling) is diluted under its
//! large safe miniz_oxide/zlib path; without_native counts only own-crate unsafe.
