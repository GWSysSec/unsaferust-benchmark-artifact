...
fn compress_gzip_roundtrip_structure() {
    ...
    // Last 8 bytes: CRC32 + ISIZE (little-endian)
    let n = out.len();
    ...
    // Compression should be at least somewhat effective on repetitive data
...
fn compress_zlib_header_and_adler() {
    ...
    // Trailing 4 bytes = Adler-32 of input, big-endian
    let n = out.len();
