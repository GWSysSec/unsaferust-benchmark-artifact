...
fn ignore_any_invalid_json_still_errors() {
    // Malformed JSON should still error even with ignore_any
    ...
    // Confirm Serialize round-trip basics for known variants
    #[derive(Serialize)]
    #[serde(tag = "type", rename_all = "snake_case")]
    enum Out {
        Ping { id: u32 },
