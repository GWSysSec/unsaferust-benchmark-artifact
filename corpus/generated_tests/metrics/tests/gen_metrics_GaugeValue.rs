...
fn test_gauge_value_update_value_basic_operations() {
    ...
    // Test increment with positive input
    ...
    // Test absolute set ignores current value
...
fn test_gauge_value_update_value_sequential_workflow() {
    // Simulate a gauge being updated multiple times in sequence
    let mut current = 0.0_f64;

    // Step 1: Set absolute to 100
...
fn test_gauge_value_update_value_fractional_precision() {
    ...
    // Floating point: 0.1 + 0.2 is close to 0.3 but not exact
    ...
    // Absolute overrides accumulated value
    ...
    // Verify the input value doesn't matter for absolute
