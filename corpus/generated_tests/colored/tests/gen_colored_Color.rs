...
fn test_to_fg_str_truecolor() {
    ...
    // Verify these are owned strings (Cow::Owned) since they are dynamically generated
    assert_ne!(fg_str, "");
...
fn test_to_bg_str_truecolor() {
    ...
    // Verify fg and bg differ for same color
    let fg_str = custom.to_fg_str();
...
fn test_fg_bg_str_consistency_with_colored_output() {
    ...
    // Verify that the ANSI codes from to_fg_str appear in the colored string output
    ...
    // Verify fg and bg codes are different for same color
...
fn test_fg_bg_str_cow_type_behavior() {
    ...
    // Basic colors should return Cow::Borrowed (static strings)
    ...
    // TrueColor returns Cow::Owned (dynamic strings)
...
fn test_fg_bg_str_all_colors_differ_from_each_other() {
    ...
    // All foreground codes should be unique
    ...
    // All background codes should be unique
    ...
    // fg and bg for same color should differ
    for color in &colors {
