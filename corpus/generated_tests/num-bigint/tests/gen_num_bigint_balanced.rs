//! Balanced unsafe-oriented test for `num-bigint` (RQ1 cycles + RQ2 heap + RQ3 insts).
//!
//! num-bigint executes only a trace of its own unsafe (limb-buffer reinterprets)
//! relative to a large safe arithmetic workload.
